                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <p class="mb-0">Agrlink admin panel</p>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    function fetchFarms($access_token) {
                                        ...
                                        if ($result !== false) {
                                            ...
                                            if(isset($decoded_result['farms'])) {
                                                return $decoded_result['farms']; // Return array of farms
                                            } else {
                                    ...
                                    if (!isset($_SESSION['access_token'])) {
                                        ...
                                        // Fetch farms using access token
                                        $farms = fetchFarms($access_token);

                                        // Append farms to the table
                                        if ($farms) {
                                            foreach ($farms[0] as $farm) { // Loop through the farms array
                                                echo "<tr>";                                                    
                                                echo "<td>" . $farm['farm_id'] . "</td>";
                                                echo "<td>" . $farm['farm_name'] . "</td>"; // Changed from 'company_name'
                                                echo "<td>" . $farm['farm_address'] . "</td>"; // Changed from 'company_address'
                                                echo "<td>" . $farm['description'] . "</td>";
                                                echo "<td><img src='" . $farm['farm_logo'] . "' alt='Farm Logo' width='85%'></td>"; // Changed from 'company_logo'
                                                echo "</tr>";
                                            }
                                        }
                                    }

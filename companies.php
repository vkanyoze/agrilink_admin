...
<head>
    ...
    <title>Companies - Agrilink</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <p class="mb-0">Your Agrlink admin panel</p>
                        </div>
                    </div>
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#companyProfileModal">
  Add Company
</button>
</br></br>
...
$(document).ready(function() {
    $('#companyProfileForm').on('submit', function(e) {
        ...
        reader.onload = function() {
            let base64Logo = reader.result.split(',')[1];  // Extract base64 data
            ...
            $.ajax({
                url: 'http://64.227.36.36:8186/agrilinkapi/admin/company_profile',
                type: 'POST',
                ...
                error: function(xhr, status, error) {
                    alert('Error submitting company profile');
                }
            });
        };
